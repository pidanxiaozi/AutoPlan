...
def test_表单测试_使用数据类(new_context):
    ...
    # my_page_测试员1.项目集.快捷操作_填写表单_增加根据数据类确定唯一表单版(项目集名称="test123",项目集周期="2025-04-04,2025-04-27",父项目集="333")
    新建项目=项目集数据类_新建项目集(项目集名称="test123",项目集周期="2025-04-04,2025-04-27",父项目集="333")
    # 新建项目.as_dict()#可以使用:新建项目.as_dict()查看dict中存放的值
    # my_page_测试员1.项目集.快捷操作_填写表单(**新建项目.as_dict(),timeout=5_000)
    # my_page_测试员1.项目集.快捷操作_填写表单_增加根据数据类确定唯一表单版(**新建项目.as_dict())
    # 项目集数据类_新建项目集(项目集名称="test125", 项目集周期="8，7", 父项目集="333")
    my_page_测试员1.项目集.快捷操作_填写表单_增加根据数据类确定唯一表单版(
        **项目集数据类_新建项目集_temp(项目集名称="test125", 项目集周期="8，7", 父项目集="333").as_dict())
    my_page_测试员1.项目集
