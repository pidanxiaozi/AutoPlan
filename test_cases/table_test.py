...
def test_new_context(new_context):
    ...
    my_page_测试员1.项目集.表单_日期选择("项目集周期", "0,1")
    my_page_测试员1.项目集.表单_日期选择("项目集周期", "2025-09-01,2025-09-01")
    my_page_测试员1.项目集.表单_日期选择("计划发布时间", "10")
    my_page_测试员1.项目集.表单_日期选择("计划发布时间", "2025-09-01")
